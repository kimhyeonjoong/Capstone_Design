...
router.post('/phone', function(req, res) {
  ...
  var sql_insert = "insert into clothtaku_member (phone) values(?);";
...
router.post('/info', function(req, res) {
  ...
  var sql_insert = "insert into clothtaku_member (phone, name, sextype, birthday) values(?, ?, ?, ?);";
  var sql_update = "update clothtaku_member set name = ?, sextype = ?, birthday = ? where phone = ?; ";
  var sql_select = "select seq from clothtaku_member where phone = ?; ";
...
router.post('/icon_upload', function (req, res) {
  ...
  form.parse(req, function(err, fields, files) {
    var sql_update = "update clothtaku_member set member_icon_filename = ? where seq = ?;";
