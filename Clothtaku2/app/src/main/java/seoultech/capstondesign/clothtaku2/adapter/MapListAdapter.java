...
/**
 * 구글 지도 맵에서 상점 정보 리스트의 아이템을 처리하는 어댑터
 */
public class MapListAdapter extends RecyclerView.Adapter<MapListAdapter.ViewHolder> {
     ...
     */
    public MapListAdapter(Context context, int resource, ArrayList<ClothInfoItem> itemList) {
     ...
     */
    public void setItemList(ArrayList<ClothInfoItem> itemList) {
        this.itemList = itemList;
