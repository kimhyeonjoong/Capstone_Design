...
/**
 * 상점 정보앱의 핵심 액티비티이며 왼쪽에 네비게이션 뷰를 가지며
...
public class MainActivity extends AppCompatActivity
    ...
    /**
     * 액티비티와 네비게이션 뷰를 설정하고 ClothtakuListFragment를 화면에 보여준다.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoLib.getInstance()
                .goFragment(getSupportFragmentManager(), R.id.content_main,
                        ClothtakuListFragment.newInstance());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_list) {
            GoLib.getInstance().goFragment(getSupportFragmentManager(),
                    R.id.content_main, ClothtakuListFragment.newInstance());

        } else if (id == R.id.nav_map) {
            GoLib.getInstance().goFragment(getSupportFragmentManager(),
                    R.id.content_main, ClothtakuMapFragment.newInstance());

        } else if (id == R.id.nav_keep) {
            GoLib.getInstance().goFragment(getSupportFragmentManager(),
                    R.id.content_main, ClothtakuKeepFragment.newInstance());

        } else if (id == R.id.nav_register) {
            GoLib.getInstance().goClothtakuRegisterActivity(this);
