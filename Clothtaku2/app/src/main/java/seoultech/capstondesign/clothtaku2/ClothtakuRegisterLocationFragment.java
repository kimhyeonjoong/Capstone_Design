...
/**
 * 상점 위치를 선택하고 저장하는 액티비티
 */
public class ClothtakuRegisterLocationFragment extends Fragment
     ...
     * ClothtakuRegisterLocationFragment 인스턴스를 생성해서 반환한다.
     * @param infoItem 상점 정보를 저장하는 객체
     * @return ClothtakuRegisterLocationFragment 인스턴스
     */
    public static ClothtakuRegisterLocationFragment newInstance(ClothInfoItem infoItem) {
        Bundle bundle = new Bundle();
        bundle.putParcelable(INFO_ITEM, Parcels.wrap(infoItem));

        ClothtakuRegisterLocationFragment fragment = new ClothtakuRegisterLocationFragment();
    ...
    /**
     * fragment_clothtaku_register_locationn.xml 기반으로 뷰를 생성한다.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View layout =
                inflater.inflate(R.layout.fragment_clothtaku_register_location, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        addressText = (TextView) view.findViewById(R.id.clothtaku_address);
    ...
    /**
     * 클릭이벤트를 처리하며 상점 정보를 담당하는 프래그먼트로 이동한다.
     * @param v 클릭한 뷰에 대한 정보
     */
    @Override
    public void onClick(View v) {
        GoLib.getInstance().goFragment(getFragmentManager(),
                R.id.content_main, ClothtakuRegisterInputFragment.newInstance(infoItem));
    }
