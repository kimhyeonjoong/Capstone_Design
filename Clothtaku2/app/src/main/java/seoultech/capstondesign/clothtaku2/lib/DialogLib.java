    ...
    public void showKeepInsertDialog(Context context, final Handler handler,
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        seoultech.capstondesign.clothtaku2.lib.KeepLib.getInstance().insertKeep(handler, memberSeq, infoSeq);
                    }
                })
                .show();
    }
    ...
    public void showKeepDeleteDialog(Context context, final Handler handler,
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        seoultech.capstondesign.clothtaku2.lib.KeepLib.getInstance().deleteKeep(handler, memberSeq, infoSeq);
                    }
                })
                .show();
    }
