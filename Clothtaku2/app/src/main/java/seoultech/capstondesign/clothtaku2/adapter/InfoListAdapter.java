package seoultech.capstondesign.clothtaku2.adapter;
...
import seoultech.capstondesign.clothtaku2.Constant;
import seoultech.capstondesign.clothtaku2.MyApp;
import seoultech.capstondesign.clothtaku2.R;
...
public class InfoListAdapter extends RecyclerView.Adapter<InfoListAdapter.ViewHolder> {
    ...
    private ArrayList<ClothInfoItem> itemList;
     ...
     */
    public InfoListAdapter(Context context, int resource, ArrayList<ClothInfoItem> itemList) {
     ...
     */
    public void setItem(ClothInfoItem newItem) {
        for (int i=0; i < itemList.size(); i++) {
            ClothInfoItem item = itemList.get(i);
     ...
     */
    public void addItemList(ArrayList<ClothInfoItem> itemList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final ClothInfoItem item = itemList.get(position);
